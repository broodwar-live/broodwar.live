defmodule BroodwarWeb.Layouts do
  ...
  def app(assigns) do
    ...
    <div class="min-h-screen flex flex-col">
      <header class="bg-base-300/60 backdrop-blur-xl border-b border-primary/5 sticky top-0 z-50">
        <nav aria-label={gettext("Main navigation")} class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden lg:flex items-center gap-0.5">
              <.nav_link href="/players" label={gettext("Players")} current_path={assigns[:current_path]} />
              <.nav_link href="/matches" label={gettext("Matches")} current_path={assigns[:current_path]} />
              <.nav_link href="/tournaments" label={gettext("Tournaments")} current_path={assigns[:current_path]} />
              <.nav_link href="/replays" label={gettext("Replays")} current_path={assigns[:current_path]} />
              <.nav_link href="/builds" label={gettext("Builds")} current_path={assigns[:current_path]} />
              <.nav_link href="/wiki" label={gettext("Wiki")} current_path={assigns[:current_path]} />
            </div>
            ...
            <div class="flex items-center gap-2.5">
              <a href="/streams" class="hidden lg:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-error/10 text-error text-xs font-semibold hover:bg-error/15 transition-colors">
                <span class="w-1.5 h-1.5 rounded-full bg-error animate-live-pulse" aria-hidden="true"></span>
                {gettext("LIVE")}
              </a>
              <.locale_toggle />
              <.theme_toggle />
          ...
          <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-10 lg:gap-8">
            ...
            <div class="col-span-2 sm:col-span-3 lg:col-span-2">
              ...
              <div class="mt-5 flex items-center gap-3">
                <a href="https://github.com/broodwar-live" target="_blank" rel="noopener" aria-label="GitHub" class="text-base-content/25 hover:text-base-content/60 transition-colors">
                ...
                <a href="https://discord.gg/broodwar" target="_blank" rel="noopener" aria-label="Discord" class="text-base-content/25 hover:text-base-content/60 transition-colors">
            ...
            <%!-- Platform --%>
            <nav aria-label={gettext("Platform")}>
            ...
            <%!-- Tournaments --%>
            <nav aria-label={gettext("Tournaments")}>
            ...
            <%!-- Community --%>
            <nav aria-label={gettext("Community")}>
  ...
  defp nav_link(assigns) do
    active? = assigns[:current_path] && String.starts_with?(assigns.current_path, assigns.href)
    ...
    <a
      ...
      class={[
        ...
        @active? && "text-base-content bg-primary/5",
        !@active? && "text-base-content/50 hover:text-base-content hover:bg-primary/5"
      ]}
    >
      {@label}
    </a>
  ...
  def locale_toggle(assigns) do
    ...
    ~H"""
    <div role="group" aria-label={gettext("Language")} class="flex items-center border border-primary/10 bg-base-300/60 rounded-lg p-0.5 gap-0.5">
      <a
        href={"?locale=en"}
        data-phx-link="redirect"
        data-phx-link-state="push"
        aria-current={@locale == "en" && "true"}
        class={[
  ...
  def theme_toggle(assigns) do
    ~H"""
    <div role="group" aria-label={gettext("Theme")} class="flex items-center border border-primary/10 bg-base-300/60 rounded-lg p-0.5 relative gap-0.5">
      <button
